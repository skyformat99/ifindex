...
XINDICATOR_API int iCrossValue(int offset, int count, double* src, double* dst);
...
XINDICATOR_API void iRefDataMore(const char* symbol, int period);
XINDICATOR_API int iGetDataCount(voidptr dataptr);
...
XINDICATOR_API int iWeight(voidptr dataptr);
XINDICATOR_API int iWeightDate(voidptr dataptr);
...
XINDICATOR_API double iNew(voidptr dataptr);
...
XINDICATOR_API const char* iOrderExtra(const char* field);
